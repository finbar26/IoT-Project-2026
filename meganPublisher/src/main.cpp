...
void sendTemp() {
  HTTPClient http;
  http.begin("http://192.168.1.135:5000/data");
...
void getPattern() {
  HTTPClient http;
  http.begin("http://192.168.1.135:5000/pattern");
...
void setup() {
  ...
  Serial.println("Server Address: http://192.168.1.135:5000/data");
...
void loop() {
  ...
  http.begin(client, "http://192.168.1.135:5000/send_pattern");
  sendTemp();
  getPattern();
